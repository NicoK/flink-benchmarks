...
@OperationsPerInvocation(value = WindowWithProcessFunctionBenchmarks.RECORDS_PER_INVOCATION)
public class WindowWithProcessFunctionBenchmarks extends StateBackendBenchmarkBase {
	...
	public static void main(String[] args)
		...
		Options options = new OptionsBuilder()
				...
				.include(".*" + WindowWithProcessFunctionBenchmarks.class.getCanonicalName() + ".*")
				.build();
...
//		IntLongApplications.reduceWindowedWithProcessFunction(context.source, GlobalWindows.create());
//		context.execute();
//	}
...
//		IntLongApplications.reduceWindowedWithProcessFunction(context.source, EventTimeSessionWindows.withGap(Time.seconds(500)));
//		context.execute();
//	}
